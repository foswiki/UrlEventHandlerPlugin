#!perl
#
# Install script for UrlEventHandlerPlugin
#
...
---+ UrlEventHandlerPlugin_installer
...
Foswiki::Extender::install( $PACKAGES_URL, 'UrlEventHandlerPlugin', 'UrlEventHandlerPlugin', @DATA );
...
__DATA__
<<<< MANIFEST >>>>
lib/Foswiki/Plugins/UrlEventHandlerPlugin.pm,0444,Perl module
data/System/UrlEventHandlerPlugin.txt,0664,Plugin topic
data/System/UrlEventHandlerPluginErrorCodes.txt,0664,
data/System/UrlEventHandlerPluginConfirmCodes.txt,0664,
data/System/UrlEventHandlerPluginMessageCodes.txt,0664,
data/System/UrlEventHandlerPluginDialogCodes.txt,0664,
templates/ueh_alert.tmpl,0444,
templates/ueh_mdialog.tmpl,0444,
templates/ueh_autodialog.tmpl,0444,

<<<< DEPENDENCIES >>>>
Foswiki::Plugins::JQueryCompatibilityModePlugin,>=0,1,perl,Required.
